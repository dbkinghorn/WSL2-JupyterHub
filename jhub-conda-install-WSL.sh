...
cp kernel-icons/anacondalogo.png /usr/local/share/jupyter/kernels/anaconda3/logo-64x64.png
...
cp kernel-icons/tensorflow.png /usr/local/share/jupyter/kernels/tensorflow2.2-cpu/logo-64x64.png
...
cp kernel-icons/pytorch-logo-light.png /usr/local/share/jupyter/kernels/pytorch1.5-cpu/logo-64x64.png
...
cp kernel-icons/tensorflow.png /usr/local/share/jupyter/kernels/tensorflow2.2-gpu/logo-64x64.png
...
cp kernel-icons/pytorch-logo-light.png /usr/local/share/jupyter/kernels/pytorch1.5-gpu/logo-64x64.png
